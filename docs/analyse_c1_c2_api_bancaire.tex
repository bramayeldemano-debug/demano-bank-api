...
La complexité cyclomatique est calculée ici à partir du graphe de flot de contrôle simplifié, avec la formule :

\[
M = D + 1
\]

où \(D\) représente le nombre de décisions du graphe.

\begin{longtable}{|P{4.1cm}|P{3cm}|P{3cm}|P{5cm}|}
\hline
\rowcolor{lightgray}
\textbf{Fonction} & \textbf{Décisions} & \textbf{Complexité \(M\)} & \textbf{Interprétation} \\
\hline
Créer un compte & 1 & 2 & Deux chemins : succès ou erreur de validation. \\
\hline
Lister les comptes & 0 & 1 & Un seul chemin séquentiel. \\
\hline
Consulter un compte & 1 & 2 & Deux chemins : compte trouvé ou introuvable. \\
\hline
Effectuer un dépôt & 3 & 4 & Quatre chemins couvrant 404, inactif, données invalides et succès. \\
\hline
Effectuer un retrait & 4 & 5 & Cinq chemins couvrant 404, inactif, données invalides, solde insuffisant et succès. \\
\hline
\end{longtable}

\section{Graphes de flot de contrôle}

Pour rester fidèle au code source, chaque graphe est donné sous forme visuelle puis sous forme de nœuds et d'arcs. Cela permet ensuite d'identifier clairement les chemins d'exécution.

\subsection{Fonction 1 : \texttt{creer\_compte}}

\begin{figure}[H]
\centering
\includegraphics[width=0.62\textwidth]{docs/graphs/creer_compte.pdf}
\caption{Graphe de flot de contrôle de \texttt{creer\_compte}}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.48\textwidth]{docs/graphs/liste_comptes.pdf}
\caption{Graphe de flot de contrôle de \texttt{liste\_comptes}}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.58\textwidth]{docs/graphs/detail_compte.pdf}
\caption{Graphe de flot de contrôle de \texttt{detail\_compte}}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.72\textwidth]{docs/graphs/effectuer_depot.pdf}
\caption{Graphe de flot de contrôle de \texttt{effectuer\_depot}}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.78\textwidth]{docs/graphs/effectuer_retrait.pdf}
\caption{Graphe de flot de contrôle de \texttt{effectuer\_retrait}}
\end{figure}
